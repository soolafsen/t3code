...
export const T3_HOMER_ACTIVITY_KINDS = {
  ...
  assignmentRevisionUpdated: "t3homer.assignment-revision.updated",
  instructionSnapshotWritten: "t3homer.instruction-snapshot.written",
  continuityPromptConsumed: "t3homer.continuity-prompt.consumed",
